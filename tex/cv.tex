...
\usepackage{sty/cvdefault}
\usepackage{sty/cvwords}

\firstname{\thefirstname{Arnaldo}} \familyname{\\\thelastname{Gaspar
V\'ejar}} \title{\normalfont \small B.Sc. Computer Engineering }

\address{3637 Armando Moock, apt 1003}{Macul, Santiago -- Chile}
\mobile{56.9.5.768.14.16}
\phone{56.2.2.723.56.00}
\email{arnaldog@gmail.com}
\homepage{cl.linkedin.com/in/arnaldogasparv}
\photo[64pt]{img/arnaldo_tiny.png}
%\quote{...}         
...
\section{Employment Goals for Globant}
	\cvline{}{Grow entirely in organization,
	understanding, arcquiring and spread his culture vision. I have been focused in develop
...
\subsection{General Background in Computer Science and Software Engineering}
	...
	\cventry{4/2014--Present} {\se} {\textsc{Modyo}} {\stgo} {}
	...
	\cventry{11/2013--3/2013} {\se} {\textsc{InstaGIS SpA}} {\stgo} {}
	...
	\cventry{7/2013--11/2013} {\se} {\mapcity} {\stgo} {}
	...
	quality.
	%\\ \textbf{References} Javier Giovannini, CEO. \url{javier.giovannini@ingennia.cl}
	\\ Root 537, Santiago.}
	...
	%\\ \textbf{References} Matías Castro, CEO. \url{matias.castro@paonde.cl}} 
	}
	...
	of \placetribeapp.
	%\\ \textbf{References} Tomás Arredondo, CEO. \url{tomas.arredondo@placetribe.cl}
	}
	...
	La Escondida (MEL).
	%\\ \textbf{References} Enrique Tietzen, CEO. \url{etietzen@jobbitbames.cl}
	}
	...
	%\\ \textbf{References} Gonzalo Fuenzalida, CEO. \url{gff@mataveri.cl}
	}
